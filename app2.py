    ...
    try:
        ...
        if aplica_info == "No":
            ...
            uso_interno = st.text_area(
                "8.1 ¿Mencione otros usos de la Información gestionada por su unidad?:",
                placeholder="Ej: en planificación, informes de gestión, atención ciudadana, etc.",
                key=f"usoint_v3_{st.session_state.contador_guardado}",
            )
            uso_sil = st.text_area(
                "8.2 Otros usos Potenciales de la información:",
                placeholder="compartir con otras instituciones, para visualización pública, generar alertas, etc.",
